...
export default function Pastries() {
  const handleOrderPastry = (pastryName: string) => {
    const whatsappNumber = "+917353775690"; // Use the same number as in WhatsAppButton
    const text = encodeURIComponent(
      `Hello! I'm on your website and would like to reserve or order the artisan pastry: "${pastryName}". Thank you!`,
    );
    window.open(
        ...
        <div className="flex flex-col md:flex-row md:items-end justify-between mb-16 gap-6">
          <div className="text-left max-w-2xl">
            ...
            <p className="font-sans text-sm md:text-base text-espresso-600 font-light leading-relaxed mt-4">
              Our French pastry chef begins lamination at 7:00 AM, using AOP
              cultured Normandy butter and stone-ground heritage flour, creating
              pastries with crisp outer glass shells and honeycomb insides.
            </p>
          </div>

          <div className="flex items-center gap-1.5 self-start md:self-auto">
            <span className="text-xs font-semibold text-espresso-800 uppercase tracking-widest">
              Fresh Batches Daily at 10:00 AM
            </span>
        ...
        >
          ...
          <div className="relative z-10 flex flex-col lg:flex-row items-center justify-between gap-8 text-left">
            <div className="max-w-2xl">
              <span className="font-mono text-[9px] uppercase tracking-widest text-luxury-gold-400 font-bold block mb-2">
                Private Celebrations
              </span>
              <h3 className="font-serif text-2xl md:text-3xl font-semibold text-white tracking-tight">
                Custom Celebration Cakes & Dessert Buffets
              </h3>
              <p className="font-sans text-sm text-coffee-cream-300 font-light leading-relaxed mt-2">
                Our pastry division accepts special bespoke commissions for
                weddings, galleries, and premium corporate events. We require 48
                hours notice for whole luxury cakes.
              </p>
            </div>
